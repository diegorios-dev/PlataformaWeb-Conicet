        ...
        <div className="w-full max-w-4xl">
          ...
          <div className="backdrop-blur-2xl bg-white/50 border border-white/60 rounded-3xl shadow-2xl p-8 mb-6">
            <div className="flex items-center justify-center gap-3 mb-2">
              <div className="p-3 rounded-2xl bg-gradient-to-br from-green-500/20 to-emerald-500/20 backdrop-blur-xl border border-white/40">
          ...
          <div className="backdrop-blur-2xl bg-white/40 border border-white/60 rounded-3xl shadow-2xl p-8">
            ...
            <div className="mb-6 space-y-6">
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-sm font-semibold text-slate-700">Rango de Fechas</h3>
                </div>
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  <Calendar className="w-5 h-5 text-slate-600" />
                  <h3 className="text-sm font-semibold text-slate-700">Filtros por Periodo</h3>
                  <span className="text-xs text-slate-500">(Independientes)</span>
                </div>
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-sm font-semibold text-slate-700">Filtrar por Zona</h3>
                </div>
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-sm font-semibold text-slate-700">Filtrar por Usuario</h3>
                </div>
              ...
              {hasFilters && (
                <button
                  ...
                  className="flex items-center gap-2 text-xs text-slate-600 hover:text-slate-800 underline"
                >
              ...
              <div className="relative flex items-center justify-center gap-3">
                {loading ? (
                  <>
                    ...
                    <span className="text-lg font-bold text-green-900">Descargando...</span>
                  </>
                ) : (
                  <>
                    <Download className="w-6 h-6 text-green-700" />
                    <span className="text-lg font-bold text-green-900">Descargar Excel</span>
                  </>
                )}
              </div>
            </button>
            ...
            <div className="mt-6 p-4 rounded-xl bg-slate-50/50 border border-slate-200/50">
              <h3 className="text-sm font-semibold text-slate-700 mb-2">Ejemplos de uso:</h3>
